(function(that) {
    ((context,fapply,console)=>{
        with (context) {
            ...
            )(async function tms_0cbe9902_38a3_4c00_975d_fb3c506148c7(context, fapply, CDATA, uneval, define, module, exports, window, globalThis, unsafeWindow, console, cloneInto, exportFunction, createObjectIn, GM, GM_info, GM_openInTab, GM_getValue, GM_setValue, GM_xmlhttpRequest, GM_registerMenuCommand) {
                    ...
                    function superVideoHelper(originalInterfaceList, playerNodes) {
                        ...
                        this.isRun = function() {
                            ...
                            for (var i = 0; i < urls.length; i++) {
                                if ((window.location.host !== "bilibili.com" && window.location.host.indexOf(urls[i]) != -1) || (window.location.host === "bilibili.com" && window.location.href.indexOf("bangumi/play") != -1)) {
                                    return true;
                                }
                            }
                            return false;
    ...
    const k = "__u__2069701.3644633973"
      , r = this[k];
    delete this[k];
    return r;
}
